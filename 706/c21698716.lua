...
function c21698716.repcon(e)
	...
	if c:GetLeaveFieldDest()~=0 then
		c:RegisterFlagEffect(21698716, RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE, 0, 1)
	end
	return c:GetFlagEffect(21698716)==0 and c:IsLocation(LOCATION_MZONE) and c:IsReason(REASON_DESTROY)
end
