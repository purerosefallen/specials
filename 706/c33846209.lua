...
function c33846209.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	c:RegisterFlagEffect(33846209,RESET_CHAIN, 0, 1)
	c:SetFlagEffectLabel(33846209,g:GetFirst():GetRealFieldID())
...
function c33846209.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local old_fid = c:GetFlagEffectLabel(33846209)
	if tc and tc:IsRelateToEffect(e) and Duel.Destroy(tc,REASON_EFFECT)>0 and fid == old_fid then
