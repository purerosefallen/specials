...
function c73580471.posop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not tc:IsImmuneToEffect(e) then
		...
		e_reset:SetCondition(c73580471.rstcon)
		e_reset:SetOperation(c73580471.rstop)
		Duel.RegisterEffect(e_reset,tp)
	end
end

function c73580471.rstcon(e,tp,eg,ep,ev,re,r,rp)
    local ecur = e:GetLabelObject()
    local tc = ecur:GetHandler()
    return tc:GetLocation() == LOCATION_MZONE and tc:GetPosition()&POS_FACEUP ~= 0
end
function c73580471.rstop(e,tp,eg,ep,ev,re,r,rp)
