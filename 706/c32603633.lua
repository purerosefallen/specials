...
function c32603633.filter(c,e,tp)
	return c:IsSetCard(0x103d) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
		and not Duel.IsExistingMatchingCard(c32603633.filter2,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,c:GetCode())
end
function c32603633.filter2(c1,c2)
	return c1:IsFaceup() and Card.IsCode(c1,c2)
end	
