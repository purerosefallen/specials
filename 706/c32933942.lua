...
function c32933942.repcon(e)
	...
	if c:GetLeaveFieldDest()~=0 then
		c:RegisterFlagEffect(32933942, RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE, 0, 1)
	end
	return c:GetFlagEffect(32933942)==0 and c:IsFaceup() and c:IsLocation(LOCATION_MZONE) and c:IsReason(REASON_DESTROY)
end
