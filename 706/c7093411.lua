...
function c7093411.repcon(e)
	...
	if c:GetLeaveFieldDest()~=0 then
		c:RegisterFlagEffect(7093411, RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE, 0, 1)
	end
	return c:GetFlagEffect(7093411)==0 and c:IsFaceup() and c:IsLocation(LOCATION_MZONE) and c:IsReason(REASON_DESTROY)
end
