...
function s.initial_effect(c)
	...
	e5:SetCondition(c73413514.limcon)
	e5:SetValue(c73413514.limval)
	c:RegisterEffect(e5)
end
function c73413514.limcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsAttackAbove(3000)
end
function c73413514.limval(e,re,rp)
	local rc=re:GetHandler()
	return rc:IsLocation(LOCATION_MZONE) and re:IsActiveType(TYPE_MONSTER)
		and rc:IsAttackBelow(3000) and rc:IsSummonLocation(LOCATION_EXTRA)
end
