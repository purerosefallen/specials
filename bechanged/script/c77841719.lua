...
function c77841719.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(77841719,1))
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_HAND)
	e3:SetCost(c77841719.cost2)
	e3:SetTarget(c77841719.target2)
	e3:SetOperation(c77841719.operation2)
	c:RegisterEffect(e3)
end
...
function c77841719.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not e:GetHandler():IsPublic() end
end
function c77841719.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanSummon(tp) and Duel.IsPlayerCanAdditionalSummon(tp)
		and Duel.GetFlagEffect(tp,77841719)==0 end
end
function c77841719.operation2(e,tp,eg,ep,ev,re,r,rp)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetDescription(aux.Stringid(77841719,2))
	...
	Duel.RegisterFlagEffect(tp,77841719,RESET_PHASE+PHASE_END,0,1)
end