...
function c76830505.initial_effect(c)
	...
	c:RegisterEffect(e1)
	local e3=e1:Clone()
	e3:SetCondition(c76830505.spcon3)
	e3:SetCost(c76830505.spcost3)
	c:RegisterEffect(e3)
	--special summon
...
function c76830505.spcon3(e,tp,eg,ep,ev,re,r,rp)
...
function c76830505.spcost3(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c76830505.tgfilter(c,e,tp)
	return c:IsCode(88667504) and c:IsAbleToGraveAsCost()
end
...
function c76830505.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
		...
		if Duel.SpecialSummonComplete() and Duel.IsExistingMatchingCard(c76830505.tgfilter,tp,LOCATION_DECK+LOCATION_HAND,0,1,nil,e,tp) and Duel.SelectYesNo(tp,aux.Stringid(76830505,2)) then
		local g=Duel.SelectMatchingCard(tp,c76830505.tgfilter,tp,LOCATION_DECK+LOCATION_HAND,0,1,1,nil)
