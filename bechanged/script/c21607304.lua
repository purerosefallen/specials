...
function c21607304.initial_effect(c)
	...
	e6:SetCondition(c21607304.poscon)
	c:RegisterEffect(e2)
end
function c21607304.pcfilter2(c,tp)
	return c:IsSetCard(0x10ed) and c:IsControler(tp)
end
function c21607304.poscon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c21607304.pcfilter2,1,nil,tp)
end
