...
function s.initial_effect(c)
	...
	e02:SetCondition(s.discon)
	e02:SetTarget(s.disable)
	e02:SetCode(EFFECT_DISABLE)
	c:RegisterEffect(e2)
	--effect
...
function s.discon(e)
	return e:GetHandler():GetMaterial():FilterCount(Card.IsSetCard,nil,0x48)==e:GetHandler():GetMaterialCount()
end
