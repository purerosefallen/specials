...
function c63977008.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(63977008,1))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_TO_HAND)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCondition(c63977008.spcon)
	e2:SetTarget(c63977008.sptg)
	e2:SetOperation(c63977008.spop)
	c:RegisterEffect(e2)
end
function c63977008.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_DECK)
end
function c63977008.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsSummonable(true,nil) end
	Duel.SetOperationInfo(0,CATEGORY_SUMMON,c,1,0,0)
end
function c63977008.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
