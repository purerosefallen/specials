...
function c8529136.initial_effect(c)
	...
	e2:SetCountLimit(1,8529136)
	e2:SetCondition(c8529136.thcon)
	e2:SetTarget(c8529136.thtg)
	e2:SetOperation(c8529136.thop)
	c:RegisterEffect(e2)
end
...
function c8529136.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		if tc:GetFlagEffect(8529136)==0 then
			...
			e6:SetCode(EFFECT_ONLY_ATTACK_MONSTER)
			e6:SetTargetRange(0,LOCATION_MZONE)
			e6:SetValue(c8529136.atklimit)
			e6:SetLabel(tc:GetRealFieldID())
			e6:SetReset(RESET_PHASE+PHASE_END)
			Duel.RegisterEffect(e6,tp)
			tc:RegisterFlagEffect(8529136,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET+RESET_PHASE+PHASE_END,0,0)
		end
...
function c8529136.atklimit(e,c)
...
function c8529136.cthfilter(c)
	return c:IsFaceup() and c:IsCode(60800381)
end
function c8529136.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c8529136.cthfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
