...
function c24212820.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(24212820,5))
	e4:SetType(EFFECT_TYPE_SINGLE)
	e4:SetCode(EFFECT_TRAP_ACT_IN_HAND)
	e4:SetCost(c24212820.cost)
	c:RegisterEffect(e4)
end
function c24212820.cfilter(c)
	return c:IsSetCard(0xdb) and c:IsAbleToGraveAsCost()
end
function c24212820.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c24212820.cfilter,tp,LOCATION_HAND,0,1,nil)
		and Duel.IsExistingMatchingCard(c24212820.tgfilter,tp,LOCATION_DECK,0,1,nil)end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c24212820.cfilter,tp,LOCATION_HAND,0,1,1,nil)
