...
function c38495396.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,nil,6,2,c38495396.ovfilter,aux.Stringid(38495396,1))
	c:EnableReviveLimit()
	--to hand
...
function c38495396.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.IsExistingTarget(c38495396.thfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,LOCATION_MZONE+LOCATION_GRAVE,1,nil) end
