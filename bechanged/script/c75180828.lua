...
function c75180828.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c75180828.cfilter,tp,LOCATION_HAND,0,1,e:GetHandler()) end
	Duel.DiscardHand(tp,c75180828.cfilter,1,4,REASON_COST+REASON_DISCARD,e:GetHandler())
end
