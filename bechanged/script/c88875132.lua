...
function c88875132.initial_effect(c)
	...
	e4:SetCountLimit(1,88875134)
	e4:SetCondition(c88875132.spcon4)
	e4:SetTarget(c88875132.sptg4)
	e4:SetOperation(c88875132.spop4)
	c:RegisterEffect(e4)
end
...
function c88875132.disfilter(c,e,tp)
	return c:IsAttribute(ATTRIBUTE_EARTH) and c:IsRace(RACE_MACHINE) and c:IsAbleToGraveAsCost()
end 
function c88875132.spcon4(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c88875132.disfilter,tp,LOCATION_HAND,0,1,c)
end
function c88875132.sptg4(e,tp,eg,ep,ev,re,r,rp,chk,c)
	local g=Duel.GetMatchingGroup(c88875132.disfilter,tp,LOCATION_HAND,0,c)
...
function c88875132.spop4(e,tp,eg,ep,ev,re,r,rp,c)
