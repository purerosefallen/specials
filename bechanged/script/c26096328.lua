...
function c26096328.initial_effect(c)
	...
	e3:SetCondition(c26096328.prccon)
	c:RegisterEffect(e3)
end
...
function c26096328.prcfilter(c)
	return c:IsFaceup() and c:IsAttribute(ATTRIBUTE_EARTH) and c:IsRace(RACE_MACHINE)
end
function c26096328.prccon(e,tp,eg,ep,ev,re,r,rp)
	local ct=Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)
	return ct==Duel.GetMatchingGroupCount(c26096328.prcfilter,tp,LOCATION_MZONE,0,nil)
end
