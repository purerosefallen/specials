...
function c71696014.initial_effect(c)
	...
	e3:SetCondition(c71696014.condition)
...
function c71696014.filter(c,e,tp)
	return c:IsSetCard(0x10a2) and c:IsLevelAbove(7) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c71696014.condition(e,tp,eg,ep,ev,re,r,rp)
