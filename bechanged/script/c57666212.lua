...
function s.initial_effect(c)
	...
	e5:SetCategory(CATEGORY_TOHAND+CATEGORY_GRAVE_ACTION+CATEGORY_SUMMON)
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if d1>0 and Duel.IsPlayerCanDraw(0,d1) and Duel.SelectYesNo(0,aux.Stringid(id,1)) then Duel.Draw(0,d1,REASON_EFFECT) end
	if d2>0 and Duel.IsPlayerCanDraw(1,d2) and Duel.SelectYesNo(1,aux.Stringid(id,1)) then Duel.Draw(1,d2,REASON_EFFECT) end
end
