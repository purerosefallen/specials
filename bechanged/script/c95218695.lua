...
function c95218695.initial_effect(c)
	...
	e6:SetCondition(c95218695.poscon)
	c:RegisterEffect(e2)
end
function c95218695.pcfilter2(c,tp)
	return c:IsSetCard(0x10ed) and c:IsControler(tp)
end
function c95218695.poscon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c95218695.pcfilter2,1,nil,tp)
end
