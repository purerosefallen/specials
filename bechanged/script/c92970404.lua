...
function c92970404.initial_effect(c)
	...
	e6:SetCondition(c92970404.poscon)
	c:RegisterEffect(e2)
end
function c92970404.pcfilter2(c,tp)
	return c:IsSetCard(0x10ed) and c:IsControler(tp)
end
function c92970404.poscon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c92970404.pcfilter2,1,nil,tp)
end
