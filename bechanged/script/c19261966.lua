...
function s.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(84330567,0))
...
function s.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsHasCategory(CATEGORY_SPECIAL_SUMMON) and re:IsActiveType(TYPE_SPELL) and re:IsHasType(EFFECT_TYPE_ACTIVATE)
end
