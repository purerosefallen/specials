...
function c76774528.initial_effect(c)
	...
	e1:SetCountLimit(1,76774528)
	e1:SetTarget(c76774528.sptg2)
	e1:SetOperation(c76774528.spop2)
	c:RegisterEffect(e1)
end
...
function c76774528.sptg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return c:IsCanBeSpecialSummoned(e,0,tp,false,false)
		and Duel.IsExistingTarget(c76774528.tfilter,tp,LOCATION_MZONE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,c76774528.tfilter,tp,LOCATION_MZONE,0,1,1,nil,tp)
