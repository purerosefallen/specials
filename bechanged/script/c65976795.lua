...
function c65976795.initial_effect(c)
	...
	e6:SetCondition(c65976795.poscon)
	c:RegisterEffect(e2)
end
function c65976795.pcfilter2(c,tp)
	return c:IsSetCard(0x10ed) and c:IsControler(tp)
end
function c65976795.poscon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c65976795.pcfilter2,1,nil,tp)
end
