...
function c51779204.initial_effect(c)
	...
	e2:SetCountLimit(1,51779204)
	e2:SetCondition(c51779204.thcon)
	e2:SetTarget(c51779204.thtg)
	e2:SetOperation(c51779204.thop)
	c:RegisterEffect(e2)
end
...
function c51779204.cfilter(c)
	return c:IsCode(70902743) and c:IsFaceup()
end
function c51779204.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c51779204.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
