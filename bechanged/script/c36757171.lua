...
function c36757171.initial_effect(c)
	...
	e2:SetCondition(c36757171.discon)
	e2:SetOperation(c36757171.disop)
	c:RegisterEffect(e2)
end
...
function c36757171.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c36757171.disop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,36757171)
