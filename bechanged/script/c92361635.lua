...
function c92361635.initial_effect(c)
	...
	e3:SetCountLimit(1,92361635)
	e3:SetTarget(c92361635.sptg1)
	e3:SetOperation(c92361635.spop1)
	c:RegisterEffect(e3)
end
...
function c92361635.desfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x24)
end
function c92361635.desfilter2(c,e)
	return c92361635.desfilter(c) and c:IsCanBeEffectTarget(e)
end
function c92361635.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsOnField() and chkc:IsControler(tp) and c92361635.desfilter(chkc) end
	local g=Duel.GetMatchingGroup(c92361635.desfilter2,tp,LOCATION_ONFIELD,0,nil,e)
