...
function c41456841.initial_effect(c)
	...
	e1:SetCondition(c41456841.hspcon)
	e1:SetTarget(c41456841.hsptg)
	e1:SetOperation(c41456841.hspop)
	c:RegisterEffect(e1)
	--indes
...
function c41456841.hspfilter(c,tp)
	return c:IsRace(RACE_INSECT) and c:IsLevelAbove(7)
		and Duel.GetMZoneCount(tp,c)>0 and (c:IsControler(tp) or c:IsFaceup())
end
function c41456841.hspcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	return Duel.CheckReleaseGroupEx(tp,c41456841.hspfilter,1,REASON_SPSUMMON,false,nil,tp)
end
function c41456841.hsptg(e,tp,eg,ep,ev,re,r,rp,chk,c)
	local g=Duel.GetReleaseGroup(tp,false,REASON_SPSUMMON):Filter(c41456841.hspfilter,nil,tp)
...
function c41456841.hspop(e,tp,eg,ep,ev,re,r,rp,c)
