...
function s.tdfilter(c)
	return c:IsAbleToHand() and c:IsSetCard(0x18c) and c:IsType(TYPE_SPELL+TYPE_TRAP+TYPE_MONSTER)
end
...
function s.bianshencon(e,tp,eg,ep,ev,re,r,rp)
...
function s.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x18c) and not c:IsCode(25550531)
end
